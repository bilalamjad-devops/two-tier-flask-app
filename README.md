...
| Webhook not triggering Jenkins | Jenkins not reachable from GitHub | Use ngrok or ensure public IP is accessible |# Two-Tier Flask App — CI/CD Pipeline (Jenkins + ArgoCD + Kubernetes)
